<template>
  <div>
    ...
    <button @click="showMessageForm= !showMessageForm" type="button"
     class="btn btn-primary">Toggle message form</button>
    <br />
  ...
  <fieldset>
    ...
    <div class="form-group">
      ...
      <input v-model="message.username" type="text" class="form-control"  placeholder="Enter Username" required>
      <small id="usernameHelp" class="form-text text-muted">Pick a username</small>
    </div>
    <div class="form-group">
      <label for="subject">Subject</label>
      <input v-model="message.subject" type="text" class="form-control" placeholder="Enter Subject" required>
    </div>
    <div class="form-group">
